...
echo "    - Shairport buffer: ~0.10s (if using tuned config)"
echo "    - PulseAudio buffer: ~0.02s (if optimized)"
echo "    - CamillaDSP buffer: ~0.023s (1024 samples @ 44.1kHz)"
echo "    - ALSA buffer: varies by hardware"
echo "    Total: ~0.15-0.3s (better for video)"
echo ""
